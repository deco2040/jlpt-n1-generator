...

{
  ...
  "correct": 0,
  "explanation": "한국어로 정답 근거 및 오답 분석"
}
...
async function callClaudeAPI(apiKey, prompt) {
  console.log("=== 🔥 FORCED MODEL UPDATE ===");
  
  // 🚨 강제로 최신 모델 사용
  const FORCED_MODEL = "claude-3-5-sonnet-20241022";
  console.log("강제 사용 모델:", FORCED_MODEL);
  
  const requestBody = {
    model: FORCED_MODEL, // 하드코딩으로 강제 적용
    max_tokens: 800,
    temperature: 0,
  ...
  console.log("요청 body model:", requestBody.model);
